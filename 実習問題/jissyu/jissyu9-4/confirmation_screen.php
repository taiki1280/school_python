...
<input type="hidden" name="year" value = "<?php echo $theYear ?>">
<input type="hidden" name="month" value = "<?php echo $theMonth ?>">
<input type="hidden" name="day" value = "<?php echo $theDay ?>">
