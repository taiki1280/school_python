...
class Add:
  ...
  def disp_add(self, number1: int, number2: int) -> None:
    print('たし算 : {} + {} = {}'
      .format(number1, number2, self.add(number1, number2)))
...
class Sub:
  ...
  def disp_sub(self, number1: int, number2: int) -> None:
    print('ひき算 : {} - {} = {}'
      .format(number1, number2, self.sub(number1, number2)))
...
class Mul:
  ...
  def disp_mul(self, number1: int, number2: int) -> None:
    print('かけ算 : {} - {} = {}'
      .format(number1, number2, self.mul(number1, number2)))
...
class Div:
  ...
  def disp_div(self, number1: int, number2: int) -> None:
    print('わり算 : {} / {} = {}'
      .format(number1, number2, self.div(number1, number2)))
...
class Mod:
  ...
  def disp_mod(self, number1: int, number2: int) -> None:
    print('剰余 : {} % {} = {}'
      .format(number1, number2, self.mod(number1, number2)))
...
class Calc(Add, Sub, Mul, Div, Mod):
  ...
  def do_calc(self) -> None:
    super().disp_add(self.__number1, self.__number2)
    super().disp_sub(self.__number1, self.__number2)
    super().disp_mul(self.__number1, self.__number2)
    super().disp_div(self.__number1, self.__number2)
    super().disp_mod(self.__number1, self.__number2)


# Calcクラスからインスタンスを生成し、変数 calc に代入
